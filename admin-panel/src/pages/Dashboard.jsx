    ...
    <Stack spacing={4}>
              ...
              <CardContent>
                {summaryData && (
                  <SummaryInfo
                    ...
                    icon={<PersonOutlineOutlinedIcon sx={{ fontSize: '3rem' }} color='warning' />}
                  />
                )}
              </CardContent>
            </Card>
              ...
              <CardContent>
                {summaryData && (
                  <SummaryInfo
                    ...
                    icon={<VerifiedUserOutlinedIcon sx={{ fontSize: '3rem' }} color='success' />}
                  />
                )}
              </CardContent>
            </Card>
              ...
              <CardContent>
                {summaryData && (
                  <SummaryInfo
                    ...
                    icon={<AddModeratorOutlinedIcon sx={{ fontSize: '3rem' }} color='primary' />}
                  />
                )}
              </CardContent>
            </Card>
              ...
              <CardContent>
                {summaryData && (
                  <SummaryInfo
                    ...
                    icon={<RoomOutlinedIcon sx={{ fontSize: '3rem' }} color='error' />}
                  />
                )}
              </CardContent>
            </Card>
      ...
      <div>
        <Grid container spacing={2}>
          <Grid item xs={4}>
            <Card elevation={0}>
              <CardHeader title={<Typography variant='h6'>Vaccinated analyst</Typography>} />
              <CardContent>
          ...
          <Grid item xs={8}>
            <Card elevation={0}>
              <CardHeader
                title={<Typography variant='h6'>Latest vaccine lots</Typography>}
                action={
              ...
              />
              <CardContent>{summaryData && <LatestVaccineLotTable list={summaryData.latestVaccineLot} />}</CardContent>
            </Card>
          </Grid>
        </Grid>
      </div>
    ...
    datasets: [
      {
        ...
        data: [chartData.userWithOneDose, chartData.userWithAboveTwoDose, chartData.userWithZeroDose],
        backgroundColor: [colors.yellow['700'], colors.green['700'], colors.red['700']],
        borderColor: [colors.yellow['700'], colors.green['700'], colors.red['700']],
        borderWidth: 1,
      },
    ],
  };
